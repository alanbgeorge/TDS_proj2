...
def GA1_13(question):
    ...
    return "https://raw.githubusercontent.com/alan/tds/refs/heads/main/email.json"
...
def GA2_3(question):
    ...
    trigger_github_workflow(
        token=token, repo="alan/website", workflow_file="daily_commit.yml"
    )  # Trigger the workflow after
    time.sleep(15)
    return "https://alan.github.io/website/?v=1"
...
async def GA2_6_file(file: UploadFile = File(...)):
    ...
    response = github_write_file(
        token, "alan/api", file_path_on_github, file_content
    )
...
async def GA2_9_file(file: UploadFile = File(...)):
    ...
    # Upload the file to GitHub
    response = github_write_file(
        token, "alan/tds_ga2_9", file_path_on_github, file_content
    )
...
def GA2_7(question):
    ...
    trigger_github_workflow(
        token=token, repo="alan/Test", workflow_file="Daily_Commit.yml"
    )
    time.sleep(15)
    return "https://github.com/alan/Test"


def GA4_8(question):
    return "https://github.com/alan/tds"
